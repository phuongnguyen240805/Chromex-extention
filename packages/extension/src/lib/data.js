import { 
// Facebook
Users, Download, Shield, FileText, BarChart2, Share2, Home, Lock, ThumbsUp, Settings, Smartphone, MessageSquare, Video, MessageCircleX, Bookmark, Eye, QrCode, Wifi, Key, Image, Mail, Gauge, Moon, DollarSign, Palette, Calendar, Percent, Clock, Type, Copy, Database, Code, Wrench, Layers, Link, AlertTriangle, Zap, Calculator, 
// Instagram
Camera, Heart, User, Search, 
// TikTok
Music, TrendingUp, Play, 
// Threads
AtSign, Hash, EyeOff, Layout, 
// Virus
Terminal, Monitor, HardDrive, Cpu, Laptop, MonitorX, Wind, Bug, Bomb, Grid, Ghost } from "lucide-react";
// ==================== FACEBOOK ====================
...
export const VIRUS_TROLL_TOOLS = [
    {
        title: "SIMULATORS",
